...
draw_sprite_ext(s_RingTarget, 0, ss_xloc, ss_yloc, scl, scl, 0.0, global.menucol, anim);
...
draw_sprite_ext(s_RingColorPulse, 0, xoff, yoff, scl, scl, 0.0, global.menucol, clamp(ringtimer/thresh_late * glowalph,0,1) * clamp(anim,0,1));
...
if(finished){
	...
	draw_sprite_ext(s_RingTarget, 0, xoff, yoff, scl, scl, 0.0, global.menucol, clamp((1 - popanim) * (multiplier - 0.3),0,1) * clamp(anim,0,1));
}

// Timing Bar
draw_sprite_ext(s_RingTimingBar, 0, ss_xloc, 564, 1.0, 1.0, 0.0, global.menucol, anim);

// Timing Handle
var xj = random_range(-handlejit,handlejit);
var yj = random_range(-handlejit,handlejit);
draw_sprite_ext(s_RingTimingHandle, 0, ss_xloc + handleoffset + xj, 564 + yj, handlescl, handlescl, 0.0, global.menucol, anim);