...
if(bDrawCombat){  
    ...
    with(Obj_CombatRenderer)
    {
        ...
        d3d_set_projection_ext( CamPosX, CamPosY, CamPosZ, CamPosX + 1, CamPosY, CamPosZ, 0, 0, 1, Obj_RenderPipeline.FOV, Obj_RenderPipeline.ScreenWidth/Obj_RenderPipeline.ScreenHeight, 0.1, 4096);
    }
}else{
